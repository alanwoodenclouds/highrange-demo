...
export function generateCustomers(count = 1050): Customer[] {
  ...
  for (let i = 1; i <= count; i++) {
    ...
    customers.push({
      ...
      phone,
      avatar: `https://api.dicebear.com/7.x/avataaars/png?seed=${first}${i}&size=128`,
      tier,
...
export function generateEmployees(count = 55): Employee[] {
  ...
  for (let i = 1; i <= count; i++) {
    ...
    employees.push({
      ...
      branch: pick(BRANCHES),
      avatar: `https://api.dicebear.com/7.x/avataaars/png?seed=emp${i}&size=128`,
...
export function generateDeliveryAgents(count = 24): DeliveryAgent[] {
  ...
  for (let i = 1; i <= count; i++) {
    ...
    agents.push({
      ...
      avatar: `https://api.dicebear.com/7.x/avataaars/png?seed=da${i}&size=128`,
      currentLocation: {
...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    name: "Ananya Menon",
    role: "Homeowner",
    avatar: "https://api.dicebear.com/7.x/avataaars/png?seed=Ananya&size=128",
    rating: 5,
  ...
  },
  {
    ...
    name: "Rahul Joseph",
    role: "Business Owner",
    avatar: "https://api.dicebear.com/7.x/avataaars/png?seed=Rahul&size=128",
    rating: 5,
  ...
  },
  {
    ...
    name: "Priya Thomas",
    role: "Teacher",
    avatar: "https://api.dicebear.com/7.x/avataaars/png?seed=Priya&size=128",
    rating: 5,
  ...
  },
  {
    ...
    name: "Vikram Nair",
    role: "Engineer",
    avatar: "https://api.dicebear.com/7.x/avataaars/png?seed=Vikram&size=128",
    rating: 4,
